...
def dining_suggestions_intent(event_info):
    ...
    EmailAddr = get_slots(event_info)["EmailAddr"]
    ...
    if source == 'DialogCodeHook':
        ...
        validation_result = validate_slots(location, cuisine, count_people, date, time, PhoneNumber)
    ...
    sqs_url = 'https://sqs.us-west-2.amazonaws.com/353077126427/Q1'
    ...
    return close(event_info['sessionAttributes'],
                 'Fulfilled',
                 {'contentType': 'PlainText',
                  'content': 'You’re all set. Expect my suggestions on your email shortly! Have a good day.'})
...
def validate_slots(location, cuisine, count_people, date, time, phonenumber):
